...
{
    GCVLOG_METHOD(@"rect1=(%.2f, %.2f) * (%.2f, %.2f)", rect.origin.x, rect.origin.y, rect.size.width, rect.size.height);
    
    CGRect compF = self.gcanvasComponent.calculatedFrame;
    GCVLOG_METHOD(@"comp rect1=(%.2f, %.2f) * (%.2f, %.2f)", compF.origin.x, compF.origin.y, compF.size.width, compF.size.height);
...
//    glGetIntegerv(GL_VIEWPORT,vpArray);
    ...
    GCVLOG_METHOD(@"rect2=(%.2f, %.2f) * (%.2f, %.2f)", rect.origin.x, rect.origin.y, rect.size.width, rect.size.height);
